...
@Entity
@Table(name = "Spa_rs")
public class Spa_rs implements Serializable {
    ...
    private String spasite_p = "";/* SPA站点 */
    ...
    @Id
    @SequenceGenerator(name = "Spa_rs", sequenceName = "Spa_rs_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Spa_rs")
