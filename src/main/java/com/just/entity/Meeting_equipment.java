...
@Entity
@Table(name = "Meeting_equipment")
public class Meeting_equipment implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "Meeting_equipment", sequenceName = "Meeting_equipment_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Meeting_equipment")
