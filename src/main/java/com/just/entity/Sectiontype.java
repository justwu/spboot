...
public class Sectiontype implements Serializable {
    ...
    private String code_p = "";/* 景区类型代码 */
    private String desc_p = "";/* 景区类型描述 */

    @Id
    @SequenceGenerator(name = "Sectiontype", sequenceName = "Sectiontype_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Sectiontype")
