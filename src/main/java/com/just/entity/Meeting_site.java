...
@Entity
@Table(name = "Meeting_site")
public class Meeting_site implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "Meeting_site", sequenceName = "Meeting_site_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Meeting_site")
