...
@Entity
@Table(name = "Boatticket")
public class Boatticket implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "Boatticket", sequenceName = "Boatticket_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Boatticket")
