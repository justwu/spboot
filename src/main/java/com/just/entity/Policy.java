...
public class Policy implements Serializable {
    ...
    private String type_p = "";/* 优先类型 ..套餐专用或者票务专用..code为唯一.加上type只是为了以后筛选用 */

    @Id
    @SequenceGenerator(name = "Policy", sequenceName = "Policy_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Policy")
