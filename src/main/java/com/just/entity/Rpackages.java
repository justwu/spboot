...
@Entity
@Table(name = "Rpackages")
public class Rpackages implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "Rpackages", sequenceName = "Rpackages_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "Rpackages")
