...
public class Hotel implements Serializable {
    ...
    private String code_p = "";/* 酒店代码 */
    private String desc_p = "";/* 酒店描述 */
    private String accountno_p = "";/* 房费账项代码,用于导数据用 */

    @Id
    @SequenceGenerator(name = "Hotel", sequenceName = "Hotel_seq", allocationSize = 1)
    ...
    @Column(length = 4, nullable = true, name = "[accountno]")
    public String getAccountno_p() {
        return EntityUtil.cutOffStr(accountno_p, this.getClass(), "accountno_p");
    }

    public void setAccountno_p(String accountno_p) {
        this.accountno_p = EntityUtil.cutOffStr(accountno_p, this.getClass(), "accountno_p");
    }
}
